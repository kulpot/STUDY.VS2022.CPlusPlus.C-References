...
//	cout << *(p + 0) << endl;	// output: 37
//	cout << *(p + 1) << endl;	// output: 6   , *(p + 1) is addition to value of int ,which is 4
//	cout << *(p + 2) << endl;	// output: 93
//	cout << *(p + 3) << endl;	// output: 32
//	cout << ages[0] << endl;	// output: 37
//	cout << ages[1] << endl;	// output: 6
//	cout << ages[2] << endl;	// output: 93
//	cout << ages[3] << endl;	// output: 32
//	cout << *(ages + 0) << endl;	// output:37
//	cout << *(ages + 1) << endl;	// output:6
//
//	//cout << ages << endl;
